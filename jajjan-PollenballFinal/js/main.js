...
window.onload = function() {
    ...
    var game = new Phaser.Game( 1200, 700, Phaser.AUTO, 'game', { preload: preload, create: create, update: update, goal_update: goal_update, goal_update1: goal_update1, goal_update2: goal_update2, polldn_collide: pollen_collide} );
    ...
    function preload() {
        ...
        game.load.image( 'hivegoal2', 'assets/hivegoal2.png' );
    ...
    function create() {
        ...
        game.physics.enable( pollen, Phaser.Physics.ARCADE );
        
        pollen2 = game.add.sprite(500,500, 'pollen');
        game.physics.enable( pollen2, Phaser.Physics.ARCADE );
        
        goal1 = game.add.sprite(0,250, 'hivegoal2');
		...
		pollen.onWorldBounds = true;
		pollen.body.bounce.setTo(1, 1);
		
		game.physics.arcade.enable(pollen2);
		pollen2.enableBody = true;
    	pollen2.body.collideWorldBounds = true;
		pollen2.body.checkCollision.up = true;
		pollen2.body.checkCollision.down = true;
		
		//pollen.setCollideWorldBounds(true);
		pollen2.onWorldBounds = true;
		pollen2.body.bounce.setTo(1, 1);
		...
		winText1 = game.add.text(500, 500, 'Player 1 Wins', { fontSize: '72px', fill: '#ffffff' });
		winText2 = game.add.text(500, 500, 'Player 2 Wins', { fontSize: '72px', fill: '#ffffff' });
    ...
    function update() {
    	...
    	game.physics.arcade.overlap(pollen2, goal1, goal_update2, null, this); 
    	game.physics.arcade.overlap(pollen2, goal2, goal_update2, null, this);

    	if (cursor1.left.isDown)
    	{
        	//  Move to the left
        	bee1.body.velocity.x = -350;
...
//        	bee2.frame = 4;
    	...
    	game.physics.arcade.collide(bee1, pollen2);
    	game.physics.arcade.collide(bee2, pollen2);
    	game.physics.arcade.overlap(pollen, pollen2, pollen_collide, null, this);
	...
	function pollen_collide (pollen, pollen2) {
    	pollen.body.velocity.y = -pollen.body.velocity.y;
    	pollen2.body.velocity.y = -pollen2.body.velocity.y;
    	pollen.body.velocity.x = (-300);
 		pollen2.body.velocity.x = (300);   	
    	//pollen.body.velocity.y = 0;

		console.log("123");

    }    
    function goal_update2(pollen2, goal) {
		pollen2.x = 500;
    	pollen2.y = 500
    	pollen2.body.velocity.x = 0;
    	pollen2.body.velocity.y = 0;
